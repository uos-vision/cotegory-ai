...
from config import dataset_dir,dataset_file_name, dataset_link_path,dataset_file_exp,model_dir, model_file_name, model_file_exp, model_link_path
...
def train_model(model_name : str , cfg : dict):
    if model_name == 'EASE' :
        ...
        os.symlink(dataset_path, model_link_path)
